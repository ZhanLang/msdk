...
struct ntfs_device_operations g_ntfs_device_win32_io_ops;
ntfs_volume *
...
Author: sudami [sudami@163.com]
Time  : 2009/03/03 [3:3:2009 - 13:59]
...
Author: sudami [sudami@163.com]
Time  : 2009/03/04 [4:3:2009 - 14:13]
...
--*/
{
	...
	//ntfs_device_default_io_ops 在这重新赋值

#if 0
	g_ntfs_device_win32_io_ops.open			= ntfs_device_win32_open;
	g_ntfs_device_win32_io_ops.close		= ntfs_device_win32_close;
	g_ntfs_device_win32_io_ops.seek			= ntfs_device_win32_seek;
	g_ntfs_device_win32_io_ops.read			= ntfs_device_win32_read;
	g_ntfs_device_win32_io_ops.write		= ntfs_device_win32_write;
	g_ntfs_device_win32_io_ops.pread		= ntfs_device_win32_pread;
	g_ntfs_device_win32_io_ops.pwrite		= ntfs_device_win32_pwrite;
	g_ntfs_device_win32_io_ops.sync			= ntfs_device_win32_sync;
	g_ntfs_device_win32_io_ops.stat			= ntfs_device_win32_stat;
	g_ntfs_device_win32_io_ops.ioctl		= ntfs_device_win32_ioctl;
#endif

	// 分配结构体
	dev = ntfs_device_alloc(name, 0, &g_ntfs_device_win32_io_ops, priv_data);
	if (!dev) { return NULL; }
