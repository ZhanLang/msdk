...
static char	g_szBase64TAB[] = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/";
static int	g_nBase64Mask[]= { 0, 1, 3, 7, 15, 31, 63, 127, 255 };
...
public:
	...
	bool Encode(unsigned char* lpbytEncoding, int lInputLength)
	{
		...
		while( nNumBits > 0 )
		{
			...
			m_result.push_back(g_szBase64TAB[nDigit]);
