...
dbL2List                  CQueryElementAllocatorTlsMgr::threadContextList;
dbMutex         CQueryElementAllocatorTlsMgr::mutex;
CQueryElementAllocatorTlsMgr* CQueryElementAllocatorTlsMgr::pInstance;
...
void* dbQueryElement::operator new(size_t size EXTRA_DEBUG_NEW_PARAMS) {
    return dbQueryElementAllocator::GetInstance()->allocate(size);
}
...
dbQueryElementAllocator::~dbQueryElementAllocator() 
{
	...
	{
		delete CQueryElementAllocatorTlsMgr::pInstance;
		CQueryElementAllocatorTlsMgr::pInstance = NULL;
	}
} 
...
{ 
    dbQueryElementAllocator::GetInstance()->deallocate(elements, nextElement);
    elements = NULL;
