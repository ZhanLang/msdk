...
public:
   ...
   CIconT_N(HICON hIcon = NULL) : m_hIcon(hIcon)
   { }
   ...
   CIconT_N<t_bManaged>& operator=(HICON hIcon)
   {
      m_hIcon = hIcon;
      return *this;
   }
...
typedef CIconT_N<true> CIcon_N;
typedef CIconT_N<false> CIconHandle_N;
...
public:
   ...
   CCursorT_N(HCURSOR hCursor = NULL) : m_hCursor(hCursor)
   { }
   ...
   CCursorT_N<t_bManaged>& operator=(HCURSOR hCursor)
   {
      m_hCursor = hCursor;
      return *this;
   }
...
typedef CCursorT_N<true> CCursor_N;
typedef CCursorT_N<false> CCursorHandle_N;
...
public:
   ...
   CAcceleratorT_N(HACCEL hAccel = NULL) : m_hAccel(hAccel)
   { }
   ...
   CAcceleratorT_N<t_bManaged>& operator=(HACCEL hAccel)
   {
      m_hAccel = hAccel;
      return *this;
   }
...
typedef CAcceleratorT_N<true> CAccelerator_N;
typedef CAcceleratorT_N<false> CAcceleratorHandle_N;


/////////////////////////////////////////////////////////////////////////////
// CLogFont_N

class CLogFont_N : public LOGFONT
{
public:
   CLogFont_N() 
   { 
   ...
   CLogFont_N(const LOGFONT& lf) 
   { 
      Copy(&lf);
   }
   CLogFont_N(HFONT hFont)
   {
   ...
   CLogFont_N& operator=(const CLogFont_N& src)
   {
      Copy(&src);
      return *this;
   }
   CLogFont_N& operator=(const LOGFONT& src)
   {
      Copy(&src);
      return *this;
   }
   CLogFont_N& operator=(HFONT hFont)
   {
      ATLASSERT(::GetObjectType(hFont)==OBJ_FONT);
      ::GetObject(hFont, sizeof(LOGFONT), (LOGFONT*) this);
      return *this;
