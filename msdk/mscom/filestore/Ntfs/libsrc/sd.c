...
void init_system_file_sd(int sys_file_no, u8 **sd_val, int *sd_val_len)
{
	...
	x_SECURITY_DESCRIPTOR_RELATIVE *sd;
	x_ACL *acl;
	x_ACCESS_ALLOWED_ACE *aa_ace;
	x_SID *sid;
	...
	*sd_val = sd_array;
	sd = (x_SECURITY_DESCRIPTOR_RELATIVE*)&sd_array;
	sd->revision = 1;
	sd->alignment = 0;
	...
	*sd_val_len = 0x64;
	 ...
	 * the DACL.
	 */
	acl = (x_ACL*)((char*)sd + le32_to_cpu(sd->dacl));
	acl->revision = 2;
	acl->alignment1 = 0;
	 ...
	 */
	aa_ace = (x_ACCESS_ALLOWED_ACE*)((char*)acl + sizeof(x_ACL));
	...
	aa_ace = (x_ACCESS_ALLOWED_ACE*)((char*)aa_ace +
	 ...
	 */
	sid = (x_SID*)((char*)sd + le32_to_cpu(sd->owner));
	sid->revision = 1;
	 ...
	 */
	sid = (x_SID*)((char*)sd + le32_to_cpu(sd->group));
	sid->revision = 1;
...
void init_root_sd(u8 **sd_val, int *sd_val_len)
{
	...
	*sd_val = (u8*)&sd_array;
	...
	sd->sacl = 0;
	sd->dacl = const_cpu_to_le32(sizeof(x_SECURITY_DESCRIPTOR_RELATIVE));

	//acl
	acl = (x_ACL*)((u8*)sd + sizeof(x_SECURITY_DESCRIPTOR_RELATIVE));
	...
	//ace1
	ace = (x_ACCESS_ALLOWED_ACE*)((u8*)acl + sizeof(x_ACL));
	...
	//ace2
	ace = (x_ACCESS_ALLOWED_ACE*)((u8*)ace + le16_to_cpu(ace->size));
	ace->type = ACCESS_ALLOWED_ACE_TYPE;
	...
	//ace5
	ace = (x_ACCESS_ALLOWED_ACE*)((char*)ace + le16_to_cpu(ace->size));
	ace->type = ACCESS_ALLOWED_ACE_TYPE;
	ace->flags = 0;
	ace->size = const_cpu_to_le16(0x14);
...
{
	x_SECURITY_DESCRIPTOR_HEADER *sds;
	x_SECURITY_DESCRIPTOR_RELATIVE *sd;
	x_ACL *acl;
	x_ACCESS_ALLOWED_ACE *ace;
	x_SID *sid;
 ...
 */
	//header
	sds = (x_SECURITY_DESCRIPTOR_HEADER*)((char*)sd_val);
	...
	//security descriptor relative
	sd = (x_SECURITY_DESCRIPTOR_RELATIVE*)((char*)sds +
			sizeof(x_SECURITY_DESCRIPTOR_HEADER));
	sd->revision = 0x01;
	sd->alignment = 0x00;
	sd->control = SE_SELF_RELATIVE | SE_DACL_PRESENT;
	sd->owner = const_cpu_to_le32(0x48);
	...
	//acl
	acl = (x_ACL*)((char*)sd + sizeof(x_SECURITY_DESCRIPTOR_RELATIVE));
	acl->revision = 0x02;
	acl->alignment1 = 0x00;
	acl->size = const_cpu_to_le16(0x34);
	...
	//ace1
	ace = (x_ACCESS_ALLOWED_ACE*)((char*)acl + sizeof(x_ACL));
	ace->type = 0x00;
	ace->flags = 0x00;
	ace->size = const_cpu_to_le16(0x14);
 ...
 */
	//header
	sds = (x_SECURITY_DESCRIPTOR_HEADER*)((char*)sd_val + 0x80);
	...
	//ace1
	ace = (x_ACCESS_ALLOWED_ACE*)((char*)acl + sizeof(ACL));
	ace->type = 0x00;
	ace->flags = 0x00;
	ace->size = const_cpu_to_le16(0x14);
