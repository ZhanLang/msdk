...
public:
	...
	bool	UnZip			(LPCTSTR package, LPCTSTR basedir, const char* password);
	LPCTSTR UnZipSpecItem	(LPCTSTR package, LPCTSTR dstpath, const char* password, int index);
	int		GetFailedItem	();

private:
	std::vector<int> m_failedItems;
	ZIPENTRY		 m_cachediteminfo;
};
