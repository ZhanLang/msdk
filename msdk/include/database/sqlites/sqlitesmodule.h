...
#if MSQLITES_VERSION_NUMBER >= 3004000
...
#if MSQLITES_VERSION_NUMBER >= 3007004
...
#if MSQLITES_VERSION_NUMBER >= 3006023
...
#if MSQLITES_VERSION_NUMBER >= 3007003
...
#endif
#if MSQLITES_VERSION_NUMBER >= 3004001
...
#if MSQLITES_VERSION_NUMBER >= 3007010
...
#if MSQLITES_VERSION_NUMBER >= 3007011
...
#if MSQLITES_VERSION_NUMBER >= 3007015
...
#if MSQLITES_VERSION_NUMBER >= 3006018
	DYNFUNC(return, const char *,          sqlite3_sourceid,              (void), ());
#endif
#if MSQLITES_VERSION_NUMBER >= 3005003
...
#endif
#if MSQLITES_VERSION_NUMBER >= 3007000
...
#if MSQLITES_VERSION_NUMBER >= 3007006
...
//		DYNFUNC_FUNC(return, int,                   sqlite3_unlock_notify,         (sqlite3 *pBlocked, void (*xNotify)(void **apArg, int nArg), void *pNotifyArg), (pBlocked, xNotify, pNotifyArg))
	...
	DECLARE_FUN_END()
		...
		virtual BOOL Exception(int iCount, HMODULE hModule, LPCSTR lpProcName)
		{
			return FALSE;
		}//default: terminal
