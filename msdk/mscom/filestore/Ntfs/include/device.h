...
struct ntfs_device_operations {
	...
	s64 (*read)(struct ntfs_device *dev, void *buf, s32 count);
	s64 (*write)(struct ntfs_device *dev, const void *buf, s32 count);
	s64 (*pread)(struct ntfs_device *dev, void *buf, s32 count, s64 offset);
	s64 (*pwrite)(struct ntfs_device *dev, const void *buf, s32 count, s64 offset);
	int (*sync)(struct ntfs_device *dev);
	int (*stat)(struct ntfs_device *dev, struct x_stat *buf);
