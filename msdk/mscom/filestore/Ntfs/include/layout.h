...
/*  8*/	x_SID sid;		/* The SID associated with the ACE. */
}x_ACCESS_ALLOWED_ACE, x_ACCESS_DENIED_ACE,
			       x_SYSTEM_AUDIT_ACE, x_SYSTEM_ALARM_ACE;
/**
...
/* sizeof() = 0x14 bytes */
}x_SECURITY_DESCRIPTOR_RELATIVE;
#pragma pack()
...
/* The below field is NOT present for the quota defaults entry. */
	x_SID sid;		/* The x_SID of the user/object associated with
