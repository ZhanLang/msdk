...
FRESULT f_open (void *, FIL*, const TCHAR*, BYTE);			/* Open or create a file */
FRESULT f_read (FIL*, void*, UINT, UINT*);			/* Read data from a file */
FRESULT f_lseek (FIL*, DWORD);						/* Move file pointer of a file object */
FRESULT f_close (FIL*);								/* Close an open file object */
FRESULT f_opendir (void *, DIR*, const TCHAR*);				/* Open an existing directory */
FRESULT f_readdir (DIR*, FILINFO*);					/* Read a directory item */
FRESULT f_stat (void *, const TCHAR*, FILINFO*);			/* Get file status */
#if !_FS_READONLY
FRESULT f_write (FIL*, const void*, UINT, UINT*);	/* Write data to a file */
FRESULT f_getfree (void *, const TCHAR*, DWORD*, FATFS**);	/* Get number of free clusters on the drive */
FRESULT f_truncate (FIL*);							/* Truncate file */
FRESULT f_sync (FIL*);								/* Flush cached data of a writing file */
FRESULT f_unlink (void *, const TCHAR*);					/* Delete an existing file or directory */
FRESULT	f_mkdir (void *, const TCHAR*);						/* Create a new directory */
FRESULT f_chmod (void *, const TCHAR*, BYTE, BYTE);			/* Change attriburte of the file/dir */
FRESULT f_utime (void *, const TCHAR*, const FILINFO*);		/* Change timestamp of the file/dir */
FRESULT f_rename (void *, const TCHAR*, const TCHAR*);		/* Rename/Move a file or directory */
#endif
#if _USE_FORWARD
FRESULT f_forward (FIL*, UINT(*)(const BYTE*,UINT), UINT, UINT*);	/* Forward data to the stream */
#endif
#if _USE_MKFS
FRESULT f_mkfs (VOID *, BYTE, BYTE, UINT);					/* Create a file system on the drive */
#endif
#if _FS_RPATH
FRESULT f_chdir (void *, const TCHAR*);						/* Change current directory */
