 ...
 */
s64 ntfs_device_win32_seek(struct ntfs_device *dev, s64 offset,
		int whence)
{
	s64 abs_ofs;
 ...
 * On error returns -1 with errno set.
 */
 s64 ntfs_device_win32_write(struct ntfs_device *dev, const void *b,
		s64 count)
{
...
int ntfs_device_win32_ioctl(struct ntfs_device *dev, int request,
		void *argp)
{
	win32_fd *fd = (win32_fd *)dev->d_private;
...
s64 ntfs_device_win32_pread(struct ntfs_device *dev, void *b,
...
s64 ntfs_device_win32_pwrite(struct ntfs_device *dev, const void *b,
		s64 count, s64 offset)
{
