...
UINT thread_proc dbServer::serverThread(void* arg)
{
    ((dbServer*)arg)->serveClient();
	return 0;
}

UINT thread_proc dbServer::acceptLocalThread(void* arg)
{
...
UINT thread_proc dbServer::acceptGlobalThread(void* arg)
{
    dbServer* server = (dbServer*)arg;
