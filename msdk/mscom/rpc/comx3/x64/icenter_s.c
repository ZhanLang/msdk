...
extern const MIDL_SERVER_INFO _RisingServerCommunication_ServerInfo;

extern RPC_DISPATCH_TABLE _RisingServerCommunication_v1_0_DispatchTable;

static const RPC_SERVER_INTERFACE _RisingServerCommunication___RpcServerInterface =
    {
    sizeof(RPC_SERVER_INTERFACE),
    {{0xFF37DF02,0xE8B0,0x4db8,{0x93,0xD1,0xFD,0x2F,0x10,0x24,0xD3,0xE1}},{1,0}},
    {{0x8A885D04,0x1CEB,0x11C9,{0x9F,0xE8,0x08,0x00,0x2B,0x10,0x48,0x60}},{2,0}},
    &_RisingServerCommunication_v1_0_DispatchTable,
    0,
    0,
    0,
    &_RisingServerCommunication_ServerInfo,
    0x04000000
    };
RPC_IF_HANDLE _MarginServerCommunication_v1_0_s_ifspec = (RPC_IF_HANDLE)& _RisingServerCommunication___RpcServerInterface;
...
static const MIDL_STUB_DESC _RisingServerCommunication_StubDesc = 
    {
    (void *)& _RisingServerCommunication___RpcServerInterface,
    MIDL_user_allocate,
    MIDL_user_free,
    0,
    0,
...
static RPC_DISPATCH_FUNCTION _RisingServerCommunication_table[] =
    {
    NdrServerCall2,
    NdrServerCall2,
    NdrServerCall2,
...
RPC_DISPATCH_TABLE _RisingServerCommunication_v1_0_DispatchTable = 
    {
    5,
    _RisingServerCommunication_table
    };

static const SERVER_ROUTINE _RisingServerCommunication_ServerRoutineTable[] = 
    {
    (SERVER_ROUTINE)Ping,
    (SERVER_ROUTINE)CheckSecurity,
    (SERVER_ROUTINE)ServerCall,
    (SERVER_ROUTINE)ServerCall1,
    (SERVER_ROUTINE)ServerCall2
    };

static const MIDL_SERVER_INFO _RisingServerCommunication_ServerInfo = 
    {
    &_RisingServerCommunication_StubDesc,
    _RisingServerCommunication_ServerRoutineTable,
    icenter__MIDL_ProcFormatString.Format,
    _RisingServerCommunication_FormatStringOffsetTable,
    0,
    0,
    0,
    0};
